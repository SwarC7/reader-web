...
public class CategoryResource {
    ...
    public CategoryResource(@Context HttpServletRequest request) {
    ...
    public Response list() throws JSONException {
        ...
        List<Category> categoryList = categoryDao.findSubCategory(rootCategory.getId(), baseResource.getPrincipal().getId());
    ...
    public Response get(
        ...
        Category category;
        try {
            category = categoryDao.getCategory(id, baseResource.getPrincipal().getId());
    ...
    public Response add(
        ...
        int displayOrder = categoryDao.getCategoryCount(rootCategory.getId(), baseResource.getPrincipal().getId());
        
        // Create the category
        Category category = new Category();
        category.setUserId(baseResource.getPrincipal().getId());
    ...
    public Response delete(
        ...
        CategoryDao categoryDao = new CategoryDao();
        try {
            categoryDao.getCategory(id, baseResource.getPrincipal().getId());
        } catch (NoResultException e) {
            throw new ClientException("CategoryNotFound", MessageFormat.format("Category not found: {0}", id));
        }
    ...
    public Response read(
        ...
        Category category;
        try {
            category = new CategoryDao().getCategory(id, baseResource.getPrincipal().getId());
        } catch (NoResultException e) {
            throw new ClientException("CategoryNotFound", MessageFormat.format("Category not found: {0}", id));
        }
